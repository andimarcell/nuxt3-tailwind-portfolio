<template>
  <header
    class="flex justify-between items-center border-gray-700 border-b mt-5 md:-items-center"
  >
...
.link {
  @apply p-2 hover:bg-gray-400 dark:hover:bg-gray-700 text-2xl md:text-base;
}
</style>
